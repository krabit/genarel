...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            @endif
            <form class="form-horizontal" name="category" action="{{ url('admin/content/page/' .$page->id) }}" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="images" value="{{ $page->images }}" placeholder="Default Input">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="intro" id="txtarea1"  cols="50" rows="4" class="form-control1 mytinymce">{{ $page->intro }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="desc" id="txtarea1"  cols="50" rows="4" class="form-control1 mytinymce">{{ $page->desc }}</textarea>
                    </div>
                </div>
