...
@section('content')
                    ...
                    <table class="timetable_sub">
                        ...
                        @foreach($cart_products as $product)
                            <tr class="rem{{$i}}">
                                ...
                                $imgaes = (isset($products[$product_id]->images) && $products[$product_id]->images) ? json_decode($products[$product_id]->images) : array();
                                ?>
                                <td class="invert-image"><a href="{{url('shop/product/'.$product_id)}}">
                                        @foreach($imgaes as $image)
                                            <img src="{{asset($image)}}" alt=" "  style="max-width: 150px" class="img-responsive">
                                            @break;
                                        @endforeach
                                    </a>
                                </td>
    ...
    <div class="container" id="w3payment">
    <div  class="row">
        <div class="col-75">
            <div class="container">
                <form name="order_form" action="{{url('shop/payment')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-50">
                            ...
                            <input type="text" id="fname" name="customer_name" placeholder="">
                            <label for="email"><i class="fa fa-envelope"></i> Email</label>
                            <input type="text" id="email" name="customer_email" placeholder="">
                            <div class="row">
                                <div class="col-50">
                                    <label for="state">Quốc gia</label>
                                    <input type="text" id="customer_country" name="customer_country" placeholder="">
                                </div>
                                <div class="col-50">
                        ...
                        <div class="col-50">
                            ...
                            <input type="text" id="adr" name="customer_address" placeholder="">
                            <label for="city"><i class="fa fa-institution"></i> Thành phố</label>
                            <input type="text" id="city" name="customer_city" placeholder="">
