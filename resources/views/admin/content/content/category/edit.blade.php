            ...
            <form class="form-horizontal" name="category" action="{{ url('admin/content/category/' .$cat->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="images" value="{{ $cat->images }}" placeholder="Default Input">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="intro" id="txtarea1"  cols="50" rows="4" class="form-control1 mytinymce">{{ $cat->intro }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8"
                    ><textarea name="desc" id="txtarea1"  cols="50" rows="4" class="form-control1 mytinymce">{{ $cat->desc }}</textarea>
                    </div>
                </div>
