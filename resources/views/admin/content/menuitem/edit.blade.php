...
@endsection
@section('content')
    <h1> Sửa menuitem {{ $menu-> id . ' : ' .$menu->name  }} </h1>
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            @endif
            <form class="form-horizontal" name="menu" action="{{ url('admin/menuitems/' .$menu->id) }}" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="link" readonly value="{{ $menu->link }}" class="form-control1" id="focusedinput" placeholder="All fill link">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="icon" value="{{ $menu->icon }}" class="form-control1" id="focusedinput" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select  name="menu_id">
                            @foreach($menus as $menua)
                                <?php $selected = ($menua->id == $menu->menu_id) ? ' selected' : ' ' ?>
                                <option  value="{{$menua->id}}"{{ $selected }}>{{$menua->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
