...
@endsection
@section('content')
    <h1> Sửa trang {{ $order-> id . ' : ' .$order->name  }} </h1>
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            @endif
            <form class="form-horizontal" name="category" action="{{ url('admin/shop/order/' .$order->id) }}" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="customer_note" id="txtarea1"  cols="50" rows="4" class="form-control1 mytinymce">{{ $order->customer_note }}</textarea>
                    </div>
                </div>
