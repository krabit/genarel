            ...
            <form class="form-horizontal" name="category" action="{{ url('admin/shop/product/' .$product->id) }}" method="post">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="priceCore" class="form-control1" value="{{$product->priceCore}}" id="focusedinput" placeholder="">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="priceSale" value="{{$product->priceSale}}" class="form-control1" id="focusedinput" placeholder="">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="stock" value="{{$product->stock}}" class="form-control1" id="focusedinput" placeholder="">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="ship_info" value="{{$product->ship_info}}" class="form-control1" id="focusedinput" placeholder="">
                    </div>
                ...
                for (var i = 1; i<1000 ;i++){
                    if($('#lfm'+lfm_btn_id_next.length < 1)){
                        html+=' <div class="form-group">\n' +
                            ...
                            '                       </span>\n' +
                            '\n' +
                            '                        <input id="thumbnai'+lfm_btn_id_next+'" class="form-control" type="text" name="images[]" value="" placeholder="Default Input">\n' +
                            '\n' +
                            '\n' +
