...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            <form class="form-horizontal" name="page" action="{{ url('admin/shop/brand') }}" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="image" value="{{old('image')}}" placeholder="Default Input">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="intro" id="txtarea1" cols="50" rows="4" class="form-control1 mytinymce">{{ old('intro') }}</textarea>
                    </div>
                </div>
