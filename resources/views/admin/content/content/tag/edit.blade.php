...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            @endif
            <form class="form-horizontal" name="tag" action="{{ url('admin/content/tag/' .$tag->id) }}" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="images" value="{{ $tag->images }}" placeholder="Default Input">
